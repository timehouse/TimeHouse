		...
		<div class="main">
			...
			<div class="header">
				...
				<div class="fat-nav">
					<div class="fat-nav__wrapper">
						<ul>
							...
							<li><a href="location.html">福利好康</a></li>
							<li><a href="location.html">會員專區</a></li>
				...
				<div class="top_links">
					<div class="top_menu">
						<ul>
							<li><a class="top_notice" href="notice.html">登入</a></li>
							<li><a class="top_contact" href="contact.html">登出</a></li>
							<li><a class="top_home" href="index.jsp">回 首 頁</a></li>
						</ul>
					</div>
				</div>
			</div>
